...
from claudewatch.ui.preferences.panes import about, graph, guide, insights, security, sessions, settings, usage
...
_SIDEBAR_ITEMS = [
    ...
    {"type": "static", "key": "graph", "label": "Graph"},
    {"type": "static", "key": "security", "label": "Security"},
    {"type": "separator"},
...
_PANE_CLASSES = {
    ...
    "graph": graph.GraphPane,
    "security": security.SecurityPane,
